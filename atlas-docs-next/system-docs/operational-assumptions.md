...
These assets must use the same real Atlas Core APIs, SDK helpers, task lifecycle rules, observation paths, and object file paths as other assets, and should not introduce fake product data paths or mock-only runtime behavior outside tests.
