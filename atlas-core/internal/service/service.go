...
func (s *Services) CreateEntity(ctx context.Context, input EntityCreateInput) (model.Entity, error) {
    ...
    if err := requireValidID("entity_id", input.EntityID); err != nil { return model.Entity{}, err }
...
func (s *Services) GetEntity(ctx context.Context, id string) (model.Entity, error) { return s.stores.GetEntity(ctx, id) }
...
func (s *Services) PatchEntity(ctx context.Context, id string, patch EntityPatchInput) (model.Entity, error) {
    ...
    if err != nil { return model.Entity{}, err }
    if patch.Subtype != nil { current.Subtype = *patch.Subtype }
    if patch.Alias != nil { current.Alias = *patch.Alias }
    current.JSON = model.MergeNamedSections(current.JSON, patch.JSON)
    if err := validateEntityInput(current.Type, current.JSON, false); err != nil { return model.Entity{}, err }
...
func (s *Services) DeleteEntity(ctx context.Context, id string) error {
    ...
    if err := s.stores.DeleteEntity(ctx, id); err != nil { return err }
...
func (s *Services) CreateObservation(ctx context.Context, input ObservationCreateInput) (model.Observation, error) {
    if err := requireValidID("observation_id", input.ObservationID); err != nil { return model.Observation{}, err }
    ...
    if err := validateObservationJSON(ctx, s.stores, s.sightings, input.ObservationID, input.JSON); err != nil { return model.Observation{}, err }
...
func (s *Services) GetObservation(ctx context.Context, id string) (model.Observation, error) { return s.stores.GetObservation(ctx, id) }
...
func (s *Services) PatchObservation(ctx context.Context, id string, patch ObservationPatchInput) (model.Observation, error) {
    ...
    if err != nil { return model.Observation{}, err }
    current.JSON = model.MergeNamedSections(current.JSON, patch.JSON)
    if err := validateObservationJSON(ctx, s.stores, s.sightings, current.ObservationID, current.JSON); err != nil { return model.Observation{}, err }
    current.UpdatedAt = s.now()
...
func (s *Services) DeleteObservation(ctx context.Context, id string) error {
    if err := s.stores.DeleteObservation(ctx, id); err != nil { return err }
...
func (s *Services) CreateTask(ctx context.Context, input TaskCreateInput) (model.Task, error) {
    if err := requireValidID("task_id", input.TaskID); err != nil { return model.Task{}, err }
    ...
    if err := validateTaskCommand(input.JSON, activeCatalog, asset, true); err != nil { return model.Task{}, err }
...
func (s *Services) GetTask(ctx context.Context, id string) (model.Task, error) { return s.stores.GetTask(ctx, id) }
...
func (s *Services) PatchTask(ctx context.Context, id string, patch TaskPatchInput) (model.Task, error) {
    ...
    if err != nil { return model.Task{}, err }
    if err := validateTaskCommand(nextJSON, cat, asset, current.Status == "pending"); err != nil { return model.Task{}, err }
...
func (s *Services) DeleteTask(ctx context.Context, id string) error {
    ...
    if err := s.stores.DeleteTask(ctx, id); err != nil { return err }
...
func (s *Services) CreateObject(ctx context.Context, input ObjectCreateInput) (model.Object, error) {
    if err := requireValidID("object_id", input.ObjectID); err != nil { return model.Object{}, err }
    if err := validateObjectInput(ctx, s.stores, input.ObjectID, input.Type, input.OwnerType, input.OwnerID, input.JSON); err != nil { return model.Object{}, err }
...
func (s *Services) GetObject(ctx context.Context, id string) (model.Object, error) { return s.stores.GetObject(ctx, id) }
...
func (s *Services) PatchObject(ctx context.Context, id string, patch ObjectPatchInput) (model.Object, error) {
    ...
    if err != nil { return model.Object{}, err }
    if patch.Type != nil { object.Type = *patch.Type }
    object.JSON = model.MergeNamedSections(object.JSON, patch.JSON)
    if err := validateObjectInput(ctx, s.stores, object.ObjectID, object.Type, object.OwnerType, object.OwnerID, object.JSON); err != nil { return model.Object{}, err }
...
func (s *Services) DeleteObject(ctx context.Context, id string) error {
    if err := s.stores.DeleteObject(ctx, id); err != nil { return err }
...
func (s *Services) UploadObjectFile(ctx context.Context, input store.ObjectUploadInput) (model.ObjectFile, error) {
    if err := requireValidID("file_id", input.File.FileID); err != nil { return model.ObjectFile{}, err }
    ...
    if err == nil { s.publishObject(ctx, "updated", object.ObjectID, object) }
    return file, nil
}
...
func (s *Services) AppendObjectFile(ctx context.Context, objectID, fileID string, reader io.Reader, maxBytes int64) (model.ObjectFile, error) {
    ...
    if err == nil { s.publishObject(ctx, "updated", objectID, object) }
    return file, nil
}
...
func (s *Services) DeleteObjectFile(ctx context.Context, objectID, fileID string) error {
    if err := s.stores.DeleteObjectFile(ctx, objectID, fileID); err != nil { return err }
    object, err := s.stores.GetObject(ctx, objectID)
    if err == nil { s.publishObject(ctx, "updated", objectID, object) }
    return nil
}
...
func (s *Services) FullQuery(ctx context.Context) (model.QuerySnapshot, error) {
    ...
    if err != nil { return model.QuerySnapshot{}, err }
...
func (s *Services) loadPinnedCatalog(ctx context.Context, objectID string) (catalog.Catalog, error) {
    ...
    _ = file
    if err != nil { return catalog.Catalog{}, err }
    defer rc.Close()
    raw, err := io.ReadAll(rc)
    if err != nil { return catalog.Catalog{}, err }
    var parsed catalog.Catalog
    if err := json.Unmarshal(raw, &parsed); err != nil { return catalog.Catalog{}, err }
    parsed.Raw = raw
    if err := catalog.Validate(parsed); err != nil { return catalog.Catalog{}, err }
    parsed.ByType = map[string]catalog.Command{}
    for _, command := range parsed.Commands { parsed.ByType[command.Type] = command }
...
func validateObjectInput(ctx context.Context, stores store.Stores, objectID, objectType, ownerType, ownerID string, jsonMap model.JSONMap) error {
    if err := requireValidID("object_id", objectID); err != nil { return err }
    ...
    if ownerType != "system" {
        var err error
        switch ownerType {
        case "entity": _, err = stores.GetEntity(ctx, ownerID)
        case "observation": _, err = stores.GetObservation(ctx, ownerID)
        case "task": _, err = stores.GetTask(ctx, ownerID)
        }
        if err != nil { return err }
